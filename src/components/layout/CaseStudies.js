        ...
        <div>
            ...
            <main>
                <section className="leadership-banner position-relative wings-top-section">
                    <img
                        src="assets/images/case-studies-banner.png"
                        alt="awards"
                    ...
                    <div className="container-fluid plr">
                        ...
                        <div className="row">
                            <div className="col-lg-4 mb-4">
                                <Link to="/case-studie-details" className="text-black text-decoration-none">
                                    <div
                                        ...
                                        <div className="team-name">
                                            <h5 className="mb-1 blog-date">January xx, xxxx</h5>
                                            <p className="text-mute blog-title">Lorem ipsum</p>
                                        </div>
                                    </div>
                                </Link>
                            </div>
